        ...
        <div className='h-full w-full flex gap-2 '>
            ...
            <div className='content w-full h-full flex flex-1 flex-col gap-4 mt-2 p-1 '>
                ...
                <div className='w-full h-auto flex gap-10 items-center p-2 bg-blue-500'>
                    ...
                    <div className='w-[30%] h-auto bg-white bg-opacity-20 p-2'>
                        <h2 className='text-lg font-medium'>{`Doctor ${prescription?.doctorId?.firstName} ${prescription?.doctorId?.lastName}`}</h2>
                        <h2></h2>

                    </div>

                    <div className='w-full flex justify-end h-auto bg-white bg-opacity-20 p-2'>
...
{/* 
                ...
                <div className='w-full h-[8vh] flex   py-1 mb-2 '>
                  <button className='w-full h-full  font-medium bg-orange-500  border' onClick={(e)=>handleDeliver(e)}>View Prescription</button>
                </div>
