...
function Patient_SuggestedDoctorCard(props) {
        ...
        <div className='details w-full h-full pl-2 pt-5 flex flex-row  gap-4 '>
            <div className='w-[50%] h-full pl-10 pt-1 flex flex-col  gap-4'>
                <div className=' w-auto'>
                    <span className='text-sm font-medium opacity-40'>Oncologist</span>
                </div>
            ...
            <div className='w-[50%] h-full pb-8 flex flex-col gap-10 justify-end pr-5'>
                ...
                <button className='w-full h-[5vh] font-medium border rounded-[5%] bg-orange-500 p-2 hover:bg-opacity-50' onClick={(e)=>navigate(`/patient/doctors/${props.doctor._id}`)}>Book Consult</button>
...
export default Patient_SuggestedDoctorCard
