...
import { patient_getCompletedOrderTestDetailsService, patient_getTestResultService } from '../../services/patientLabTestServices'


function Patient_TestResultPage() {
    ...
    const onLoad=async ()=>{
        const tempOrder=await patient_getCompletedOrderTestDetailsService({testOrderId})
        const testResult=await patient_getTestResultService({testOrderId})
        if(testResult){
...
export default Patient_TestResultPage
