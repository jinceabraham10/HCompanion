  ...
  return (
    <div className='screen w-full h-full flex flex-row gap-4'>
        <div className='sideOptions w-[18%] p-4 h-full grid grid-cols-1 gap-6 border shadow-lg shadow-emerald-300'>
            ...
            <Link className='options p-4 font-medium bg-emerald-400 bg-opacity-20 flex items-center gap-2 border'><FaUserDoctor className='w-[3vw] h-[3vh]'/>Doctor Details<span></span></Link>

        </div>

        <div className='content w-[60%] flex flex-1 flex-col'>
            <Outlet/>
        </div>
