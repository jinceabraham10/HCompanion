...
import { laboratory_approval_getAllDetailsService } from '../../services/laboratoryProfileDetailsService';



function Laboratory_ApprovalFormSubmitted() {
...
//    console.log(formik.values)
   ...
   const onLoad=async ()=>{
    const tempDetails=await laboratory_approval_getAllDetailsService()
    if(tempDetails){
...
export default Laboratory_ApprovalFormSubmitted