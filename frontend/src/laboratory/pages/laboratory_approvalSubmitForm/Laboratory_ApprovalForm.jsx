...
import { laboratory_approval_updateProfileDetailsService } from '../../services/laboratoryProfileDetailsService';



function Laboratory_ApprovalForm() {
    ...
    const formik=useFormik({
        ...
        onSubmit:async (values,actions)=>{
            const updatedDetails=await laboratory_approval_updateProfileDetailsService(values)
            if(updatedDetails){
    ...
    <div className='w-full h-auto flex'>
        <div className='w-full h-auto flex justify-center p-5'>
            ...
            <h2 className='w-full h-[5vh] bg-red-500 flex items-center justify-center text-white text-bold '>Approval Form</h2>
                ...
                <FloatingLabel variant='filled' label='Laboratory Name' name='laboratoryName' value={formik.values.laboratoryName} onChange={formik.handleChange}/>
...
export default Laboratory_ApprovalForm
