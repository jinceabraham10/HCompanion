...
import { laboratory_getContactDetailsService, laboratory_updateContactDetailsService } from '../../services/laboratoryProfileDetailsService'

function Laboratory_ContactPage() {
    const formik=useFormik({
        ...
        onSubmit:async (values,actions)=>{
            if(await laboratory_updateContactDetailsService(values))
                onLoad()
    ...
    const onLoad=async ()=>{
        const {phone,...tempContactDetails}=await laboratory_getContactDetailsService()
...
export default Laboratory_ContactPage
