...
function Admin_UsersOptions() {
  return (
    <div className='w-full h-[10vh] px-2 text-center font-bold flex justify-center items-center gap-2 '>
        ...
        <Link className='options w-[35%] h-[80%] font-bold justify-center items-center p-2 bg-opacity-80 shadow-lg shadow-emerald-200 pl-4 flex items-center gap-5 border  ' to=''><IoMdSchool className='h-[3vh] w-[2vw]'/><span className='flex flex-1' to='/admin/users/pharmacy'>Pharmacies</span></Link> 
