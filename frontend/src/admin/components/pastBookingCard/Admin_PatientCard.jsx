...
function Admin_PatientCard(props) {
 const {user}=props
  ...
  return (
      <div className='w-full h-full '>
          <div className='w-full h-full flex gap-2 border shadow-lg p-4 bg-white rounded-lg hover:bg-black hover:bg-opacity-10 cursor-pointer'>
              ...
              <h1 className='w-full h-[5vh] p-4 bg-blue-500 flex justify-center items-center text-white '>{`Normal User`}</h1>
...
export default Admin_PatientCard
