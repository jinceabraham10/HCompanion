...
function Admin_ApprovalLaboratoryCard(props) {
 const {user}=props
          ...
          <div className='w-full h-full flex gap-2 border shadow-lg p-4 bg-white rounded-lg hover:bg-black hover:bg-opacity-10 cursor-pointer'>
              ...
              <div className='details w-auto h-full px-2 py-2 flex flex-col gap-4 flex-1 items-start border bg-black bg-opacity-5 '>
                  ...
                  <div className='w-full h-auto'>
                      <h4 className='flex justify-center w-full text-emerald-500'>{`${user?.laboratoryName}`}</h4>
                  </div>
              ...
              <div className='w-auto h-full flex flex-1 flex-col justify-end font-bold gap-4 py-2 px-2 bg-emerald-200 bg-opacity-40'>
                   <h1 className='w-full h-[5vh] p-4 bg-blue-500 flex justify-center items-center text-white '>{`Laboratory`}</h1>
                  ...
                  <div className='w-full h-auto flex gap-2'>
                        <button className='cancel w-full h-auto p-2 bg-orange-500 font-medium flex items-center justify-center' onClick={(e)=>navigate(`/admin/approval/laboratoryDetails?labId=${user._id}`)} >
                                View Details
                        </button>
...
export default Admin_ApprovalLaboratoryCard
