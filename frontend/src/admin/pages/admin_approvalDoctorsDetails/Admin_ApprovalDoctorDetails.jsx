...
import { admin_approval_approveDoctorService, admin_approval_getAllDoctorDetailsService, admin_approval_getAllPharmaciesService } from '../../services/admin_approvalServices';



function Admin_ApprovalDoctorDetails() {

        const [userparams]=useSearchParams()
        const doctorId=userparams.get('doctorId')
...
//    console.log(formik.values)
  ...
  const handleApprove=async (e)=>{
    // e.preventDefault();
    const approved=await admin_approval_approveDoctorService({doctorId})
    if(approved){
   ...
   const onLoad=async ()=>{
    const tempDetails=await admin_approval_getAllDoctorDetailsService({doctorId})
    if(tempDetails){
...
export default Admin_ApprovalDoctorDetails