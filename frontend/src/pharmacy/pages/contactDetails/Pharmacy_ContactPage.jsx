...
import { pharmacy_getContactDetailsService, pharmacy_updateContactDetailsService } from '../../services/pharmacyProfileService'
function Pharmacy_ContactPage() {
    const formik=useFormik({
        ...
        onSubmit:async (values,actions)=>{
            if(await pharmacy_updateContactDetailsService(values))
                onLoad()
    ...
    const onLoad=async ()=>{
        const {phone,...tempContactDetails}=await pharmacy_getContactDetailsService()
...
export default Pharmacy_ContactPage
