...
import { pharmacy_approval_getAllDetailsService } from '../../services/pharmacyProfileService';


function Pharmacy_ApprovalFormSubmitted() {
...
//    console.log(formik.values)
   ...
   const onLoad=async ()=>{
    const tempDetails=await pharmacy_approval_getAllDetailsService()
    if(tempDetails){
...
export default Pharmacy_ApprovalFormSubmitted