...
function Pharmacy_MedicineCard(props) {
        ...
        <div className='h-full w-full flex gap-2 '>
            ...
            <div className='content w-full h-full flex flex-1 flex-col gap-4 mt-2 p-1 '>
                ...
                <div className='w-full h-[8vh] flex  px-2 py-1 mb-2 '>
                  <button className='w-full h-full  font-medium bg-orange-500  border' onClick={(e)=>handleDeliver(e)}>Delivered</button>
                </div>
...
export default Pharmacy_MedicineCard
